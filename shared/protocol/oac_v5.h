...
#define OAC_PRODUCTION_PROTOCOL_VERSION 0x00050005UL
...
OAC_V5_STATIC_ASSERT(sizeof(OAC_V5_STATUS_RESPONSE) == 168,
...
OAC_V5_STATIC_ASSERT(FIELD_OFFSET(OAC_V5_STATUS_RESPONSE, Reserved) == 132,
    "OAC_V5_STATUS_RESPONSE reserved field moved");
