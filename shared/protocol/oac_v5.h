...
#define OAC_PRODUCTION_PROTOCOL_VERSION 0x00050006UL
...
OAC_V5_STATIC_ASSERT(sizeof(OAC_V5_STATUS_RESPONSE) == 200,
...
OAC_V5_STATIC_ASSERT(FIELD_OFFSET(OAC_V5_STATUS_RESPONSE, ManifestSha256) == 136,
    "OAC_V5_STATUS_RESPONSE manifest digest moved");
OAC_V5_STATIC_ASSERT(
    FIELD_OFFSET(OAC_V5_STATUS_RESPONSE, BackendBindingSha256) == 168,
