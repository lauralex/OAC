...
static POAC_CPU_RESPONSE g_ActiveResponse;
    ...
    _Out_ PULONG BytesWritten)
{
    ...
    *BytesWritten = 0;
    ...
    captured = min(captured, capacity);
    Response->Count = captured;
    Response->Size = headerSize + captured * sizeof(OAC_CPU_RECORD);
